...
class Node {
    constructor(absolutePath, parent = null) {
        ...
        this.absolutePath = (0, normalize_1.normalizePath)(absolutePath);
        if (parent) {
    ...
    get relativePath() {
        return (0, normalize_1.relative)(this.parent?.absolutePath ?? "", this.absolutePath);
    }
    detachFromParent() {
        if (this.parent) {
...
function _generateRootNode(files) {
    const allFiles = files.map((d) => (0, normalize_1.normalizePath)(d));
    const root = new Node("");
